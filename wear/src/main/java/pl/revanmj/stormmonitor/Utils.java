...
public class Utils {
    ...
    public static List<StormData> getAllData(Context context){
        String[] projection = {StormDataProvider.KEY_ID, StormDataProvider.KEY_CITYNAME,
                StormDataProvider.KEY_STORMCHANCE, StormDataProvider.KEY_STORMTIME,
                StormDataProvider.KEY_RAINCHANCE, StormDataProvider.KEY_RAINTIME};
    ...
    public static int getStormData(List<StormData> list, Context context) {
